        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 animate-fade-in-up">
            <div className="space-y-6">
              ...
              <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-xl border border-yellow-500/20 animate-scale-in animation-delay-1000">
          ...
          <div className="relative animate-fade-in-right animation-delay-600">
            <div className="grid grid-cols-2 gap-6">
              {/* Experience */}
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-xl border border-yellow-500/20 transform hover:scale-105 transition-all duration-300 animate-fade-in-up animation-delay-800">
                <div className="w-12 h-12 bg-yellow-500/20 rounded-xl flex items-center justify-center mb-4">
                  <Award className="h-6 w-6 text-yellow-400" />
                </div>
                <h3 className="text-xl font-bold text-white mb-2">Experience</h3>
                <p className="text-gray-300 text-sm">
                  3+ years of helping students achieve their academic goals with proven teaching methods.
                </p>
              </div>
              
              {/* Passion */}
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-xl border border-blue-500/20 transform hover:scale-105 transition-all duration-300 mt-8 animate-fade-in-up animation-delay-1000">
              ...
              {/* Care */}
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-xl border border-red-500/20 transform hover:scale-105 transition-all duration-300 -mt-4 animate-fade-in-up animation-delay-1200">
              ...
              {/* Support */}
              <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-xl border border-green-500/20 transform hover:scale-105 transition-all duration-300 animate-fade-in-up animation-delay-1400">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="w-20 h-20 bg-gradient-to-br from-yellow-500/20 to-slate-800/20 rounded-full border border-yellow-500/30 flex items-center justify-center backdrop-blur-sm animate-bounce-in animation-delay-1600">
