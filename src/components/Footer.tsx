...
export default function Footer() {
  return (
    <footer className="bg-slate-900 border-t border-yellow-500/20 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute -bottom-16 -left-16 w-48 h-48 bg-blue-500/5 rounded-full blur-2xl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@adhyanguidance.com" className="text-gray-300 hover:text-yellow-400 transition-colors duration-200">
                    info@adhyanguidance.com
                  </a>
                </div>
              </div>
        ...
        {/* Bottom Footer */}
        <div className="py-8 border-t border-yellow-500/20">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              <p className="text-gray-400 text-sm">
                © 2024 Adhyan Guidance. All rights reserved.
              </p>
